...
public class CheckoutPresenter extends MvpPresenter<CheckoutView, CheckoutProvider> {
    ...
    public CheckoutPresenter(final CheckoutStateModel persistentData,
                             ...
                             @Nullable final DiscountConfiguration discountConfiguration) {
    ...
    private void resolvePreSelectedData() {
        ...
        //TODO 30/07/2018 Resolver si tiene sentido la lógica de descuento de éste método en conjunto con la de discountConfiguration.
        if (discount != null) {
            discountRepository.configureMerchantDiscountManually(discountConfiguration);
        }
    }
